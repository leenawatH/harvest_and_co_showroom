...
export default function PotTable({ pots }: { pots: Pot[] }) {
  ...
  return (
    <div className="overflow-x-auto mb-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-semibold">Pot List</h2>
      ...
      <table className="min-w-full bg-white">
        <thead className="text-left text-gray-700 text-base">
          <tr>
            ...
            <th className="p-4 text-center w-36">Color</th>
        ...
        <tbody className="text-sm text-gray-700">
          {pots.map((item) => (
            <tr key={item.id} className="border-t hover:bg-gray-50">
              ...
              <td className="p-4 text-center align-middle">
                    {item.color?.map((pot) => (
                    <div key={pot.color} className="mb-2">
                        <ul>
                            <li>{pot.color}</li>
                        </ul>
                    </div>
