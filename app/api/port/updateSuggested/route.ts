...
export async function PUT(req: NextRequest) {
  ...
  console.log("🔧 Update suggested port with ID:", id, "to suggest number:", suggest_number);
  ...
  // ✅ ถ้ามี port อยู่ตำแหน่งนี้ก่อนหน้า → เคลียร์ก่อน
  if (selectOldData) {
  ...
  // ✅ อัปเดต port ใหม่ให้เข้าตำแหน่ง
  ...
  console.log("🔧 Updated port data:", data);
