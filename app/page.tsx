...
export default function HomePage() {
    return (
        <div>
                        ...
                        <div className="flex md:grid md:grid-cols-3 gap-4 md:gap-20 px-1 sm:px-2 md:px-0 w-[600px] sm:w-[700px] md:w-full">
                            {["https://res.cloudinary.com/dtppo2rxs/image/upload/c_crop,h_1350,g_south/c_crop,g_center,w_1200,h_1200/v1747462203/27_ndpr7c.png",
                                ...
                                <Link key={i} href="/" className="flex-shrink-0 w-[28%] sm:w-[28%] md:w-full max-w-sm block h-full">
                                    <div className="rounded-3xl md:p-4 hover:shadow-lg transition transform hover:scale-105 h-full flex flex-col justify-between">
                                        ...
                                        <p className="text-sm items-center justify-center text-center text-gray-600">ราคา xxx บาท</p>
                                    </div>
                                </Link>
                            ))}
                        </div>
            ...
            <section className="px-4 py-4 flex justify-center">
                <div className="w-full max-w-6xl">
                    <h2 className="text-3xl font-semibold mt-4 mb-4 text-left">กระถาง</h2>
